...
#include "../WIPING50.cpp"
#undef main

std::string INPUT_1 = "3 4 1 2 1 3 4 5 1 2 3 2 6 1 3 2 3 0 2 1 3";
std::string CORRECT_ANSWER_1 = "31 4 19 ";
std::string INCORRECT_ANSWER_1 = "0 0 0 ";
...
/*
// loops printing 0 for some reason
