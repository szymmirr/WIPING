...
#include "../WIPING34.cpp"
#undef main

std::string INPUT_1 = "abcd aabbccadadcdcdbbaaccbb";
std::string CORRECT_ANSWER_1 = "0";
std::string INCORRECT_ANSWER_1 = "2";

std::string INPUT_2 = "ab aabbccadadcdcdbbaaccbb";
std::string CORRECT_ANSWER_2 = "2";
