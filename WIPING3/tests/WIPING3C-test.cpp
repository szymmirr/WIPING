...
#include "../WIPING3C.cpp"
#undef main

std::string INPUT_1 = "<html><head></head><body><table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table></body></html>";
std::string CORRECT_ANSWER_1 = "4 6 ";
